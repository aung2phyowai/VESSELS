...
namespace VESSELS
{
    class RingAppGameScreen : GameScreen
    {
        #region Fields

        //Game Logic
        RingAppCore ringAppCore;
        ...
        public override void LoadContent()
        {
            ...
            //Start New Game
            ringAppCore = new RingAppCore(ScreenManager);
            ringAppCore.Initialize();
            ringAppCore.DrawOrder = 1;
            components.Add(ringAppCore);
