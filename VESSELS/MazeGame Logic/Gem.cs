    ...
    class Gem
    {
        ...
        public Vector2 Position
        {
            get
            {
                ...
                return basePosition + new Vector2(0.0f, bounce) - new Vector2(13, 13);
        ...
        /// </summary>
        public Gem(Level level, Vector2 position, int gemType)
        {
            this.level = level;
        ...
        {
            texture = Level.Content.Load<Texture2D>(@"Textures/Sprites/circle2");
            texture2=Level.Content.Load<Texture2D>(@"Textures/Sprites/cherry");
            origin = new Vector2(texture.Width / 2.0f, texture.Height / 2.0f);
            collectedSound = Level.Content.Load<SoundEffect>("AudioLibrary/GemCollected");
        }
        ...
        public void Update(TimeSpan TotalTime)
        {
            if (gemType == 2)
            {
                ...
                double t = TotalTime.TotalSeconds * BounceRate + Position.X * BounceSync;
        ...
        public void Draw(TimeSpan elapsedTime, SpriteBatch spriteBatch)
        {
            if (gemType==1)
                ...
                spriteBatch.Draw(texture2, Position, null, Color, 0.0f, origin, 1.0f, SpriteEffects.None, 0.0f);
        }
    }
}
